The goal of this sample is to just use as much of the default install of Node.js as possible, and install as few additional modules as possible to make an API call and process the returned JSON.
